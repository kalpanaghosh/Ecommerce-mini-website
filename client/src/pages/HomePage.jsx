 ...
 */
const SkeletonCard = () => (
  <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden animate-pulse flex flex-col h-full relative">
    <div className="w-full aspect-[4/3] bg-gray-200" />
    <div className="p-5 flex flex-col flex-grow relative bg-white">
      <div className="absolute -top-4 right-4 bg-white shadow-sm border border-gray-100 px-8 py-3 rounded-full z-20" />
    ...
    <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-[0_2px_10px_-3px_rgba(6,81,237,0.1)] hover:shadow-[0_20px_40px_-15px_rgba(6,81,237,0.15)] dark:shadow-none dark:hover:shadow-[0_0_30px_rgba(0,0,0,0.5)] hover:-translate-y-2 transition-all duration-300 ease-out group flex flex-col h-full border border-gray-100 dark:border-gray-700 overflow-hidden relative">
      ...
      <div className="relative overflow-hidden aspect-[4/3] bg-gray-50 flex items-center justify-center">
        ...
        <div className="absolute top-3 left-3 z-20 flex flex-col gap-2 pointer-events-none">
          {product.category && (
            <span className="bg-white/80 backdrop-blur-md text-slate-800 text-[11px] font-bold px-3 py-1.5 rounded-full shadow-sm uppercase tracking-widest border border-white/50">
              {product.category}
            </span>
          )}
        </div>
        ...
        <button 
          ...
          className={`absolute bottom-3 right-3 z-20 p-2.5 rounded-full shadow-md backdrop-blur-md transition-all duration-300 hover:scale-110 active:scale-95 group/heart ${
            isWishlisted 
      ...
      <div className="p-5 flex flex-col flex-grow relative bg-white dark:bg-gray-800">
        ...
        <div className="absolute -top-4 right-4 bg-white dark:bg-gray-800 shadow-md border border-gray-100 dark:border-gray-700 px-3 py-1 rounded-full z-20 flex items-center">
          {product.rating && <StarRating rating={product.rating} />}
        </div>

        <Link to={`/product/${product._id}`} className="block mt-2 mb-1 z-10">
          <h3 className="text-[1.05rem] font-bold text-gray-900 line-clamp-1 group-hover:text-indigo-600 transition-colors leading-tight font-sans">
            {product.title}
          </h3>
        </Link>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-14">
            <button 
              ...
              className="px-8 py-4 bg-white text-indigo-900 rounded-full font-bold text-lg hover:bg-indigo-50 hover:scale-105 transition-all duration-300 shadow-[0_0_20px_rgba(255,255,255,0.3)] flex items-center gap-2 group"
            >
              Shop Now
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 max-w-4xl mx-auto border-t border-white/10 pt-10">
            <div className="flex flex-col items-center text-center">
              <div className="w-12 h-12 rounded-full bg-white/10 flex items-center justify-center mb-3 backdrop-blur-md border border-white/5">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-10" id="products-grid">
          <div className="flex items-center justify-between mb-6 border-b border-gray-200 pb-4">
            ...
            {!loading && (
              <span className="hidden sm:inline-block text-sm font-medium text-gray-500 bg-gray-100 px-3 py-1 rounded-full">
              ...
              <button
                ...
                className={`px-5 py-2.5 rounded-xl text-sm font-semibold transition-all duration-300 ${
                  selectedCategory === category
                    ...
                    : 'bg-white text-gray-600 border border-gray-200 hover:border-indigo-300 hover:bg-indigo-50/50 hover:text-indigo-700 hover:shadow-sm'
                }`}
              >
                {category}
              </button>
